...
// NewBundle [root@vm nginx_1]# pwd
// /run/containerd/io.containerd.runtime.v2.task/default/nginx_1
// [root@vm nginx_1]# ls
// config.json  rootfs  work
// [root@vm nginx_1]# ll
// 总用量 4
// -rw-r--r-- 1 root root 2926 6月   4 18:14 config.json
// drwx--x--x 2 root root   40 6月   4 18:13 rootfs
// lrwxrwxrwx 1 root root   65 6月   4 18:14 work -> /var/lib/containerd/io.containerd.runtime.v2.task/default/nginx_1
