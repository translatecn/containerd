...
func (e *execProcess) start(ctx context.Context) (err error) {
	...
	var (
		socket  *runc.Socket
		pio     *processIO                     // e.id  随机生成的ID
		pidFile = newExecPidFile(e.path, e.id) // /run/containerd/io.containerd.runtime.v2.task/k8s.io/5571e7fd23ab994c76f7798ea6807b4fabb83edc3cafd1b15eece9a40d504fd1
	)
	if e.stdio.Terminal {
	...
	opts := &runc.ExecOpts{
		PidFile: pidFile.Path(), // /run/containerd/io.containerd.runtime.v2.task/k8s.io/5571e7fd23ab994c76f7798ea6807b4fabb83edc3cafd1b15eece9a40d504fd1/3d769cfc43d3a39fd3916bbddf2968186decd094cbd7d29141bfce6d030f85ad.pid
		Detach:  true,
	}
	if pio != nil {
		opts.IO = pio.IO()
