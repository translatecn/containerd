...
`,
	...
	Action: func(context *cli.Context) error {
		...
		for _, layer := range LayerInfos {
			...
			fmt.Fprintf(w, "%d\t%s\t%s\t%d\t%s\t%s\t\n", layer.Index, layer.Descriptor.Digest.String(), over_platforms.Format(*layer.Descriptor.Platform), layer.Descriptor.Size, strings.Join(schemes, ","), strings.Join(recipients, ", "))
		}
		w.Flush()
		return nil
	},
