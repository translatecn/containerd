...
func (p *Init) Stdio() stdio2.Stdio {
	return p.stdio
}
...
func withConditionalIO(c stdio2.Stdio) runc.IOOpt {
...
func New(id string, runtime *runc.Runc, stdio stdio2.Stdio) *Init {
	p := &Init{
		id:        id,
		runtime:   runtime,
...
func (p *Init) Create(ctx context.Context, r *CreateConfig) error {
	...
	if r.Terminal {
		if socket, err = runc.NewTempConsoleSocket(); err != nil { // /run/user/0/pty1400478159/pty.sock
