...
// MkdirAllWithACL is a custom version of my_mk.MkdirAll modified for use on Windows
...
// MkdirAll is a custom version of my_mk.MkdirAll that is volume path aware for
// Windows. It can be used as a drop-in replacement for my_mk.MkdirAll.
func MkdirAll(path string, _ os.FileMode) error {
	return mkdirall(path, nil)
}

// mkdirall is a custom version of my_mk.MkdirAll modified for use on Windows
...
func mkdirall(path string, perm *windows.SecurityAttributes) error {
	...
	// The rest of this method is largely copied from my_mk.MkdirAll and should be kept
...
// type *PathError. .
//
// This is a modified and combined version of my_mk.Mkdir and windows.Mkdir
// in golang to cater for creating a directory am ACL permitting full
// access, with inheritance, to any subfolder/file for Built-in Administrators
// and Local System.
func mkdirWithACL(name string, sa *windows.SecurityAttributes) error {
	if sa == nil {
		return my_mk.Mkdir(name, 0)
	}
