...
// is reflected in the https://demo/pkg/cni/blob/master/SPEC.md file
...
import (
	...
	"demo/pkg/cni/pkg/over_utils"
	"demo/pkg/cni/pkg/types"
	"demo/pkg/cni/pkg/types/create"
...
func (c *CNIConfig) addNetwork(ctx context.Context, name, cniVersion string, net *NetworkConfig, prevResult types.Result, rt *RuntimeConf) (types.Result, error) {
	...
	if err := over_utils.ValidateContainerID(rt.ContainerID); err != nil {
		return nil, err
	}
	if err := over_utils.ValidateNetworkName(name); err != nil {
		return nil, err
	}
	if err := over_utils.ValidateInterfaceName(rt.IfName); err != nil {
		return nil, err
	}
...
func (c *CNIConfig) cacheAdd(result types.Result, config []byte, netName string, rt *RuntimeConf) error {
	...
	// /var/lib/cni/results/cni-loopback-845166e0e924ff70aff7f78bc9597fad03cb0ef0b1978a8868d5320929c53ddc-lo
	fname, err := c.getCacheFilePath(netName, rt)
	if err != nil {
		return err
	}
