...
`,
	...
	Action: func(context *cli.Context) error {
		...
		if pss := context.StringSlice("platform"); len(pss) > 0 {
			...
			exportOpts = append(exportOpts, archive.WithPlatform(over_platforms.Ordered(all...)))
		} else {
			exportOpts = append(exportOpts, archive.WithPlatform(over_platforms.DefaultStrict()))
		}
