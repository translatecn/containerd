...
var (
	...
	downloadLink = "https://github.com/containerd/releases/download/v1.5.4/containerd-1.5.4-linux-amd64.tar.gz"
...
func initInSteps() bool {
	...
	if !haveExtractedBinaries {
		err := my_mk.MkdirAll(binariesDir, 0777)
		if err != nil {
			return true
		}
...
func updatePathEnv() error {
	...
	err := my_mk.MkdirAll(defaultState, 0777)
	if err != nil {
		return err
	}
