...
func (c *CriService) execInternal(ctx context.Context, container containerd.Container, id string, opts execOptions) (*uint32, error) {
	...
	volatileRootDir := c.getVolatileContainerRootDir(id) // /run/containerd/io.containerd.grpc.v1.cri/containers/4f1dc52f582866b3c105e76ab679b0535e95430c6ccbb25f8e7791fcc6da55fb
	...
	attachDone := execIO.Attach(io2.AttachOptions{ // 在这里完成了数据的对拷 ✅
		Stdin:     opts.stdin,
		Stdout:    opts.stdout,
		Stderr:    opts.stderr,
		Tty:       opts.tty,
