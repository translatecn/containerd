...
func init() {
	plugin.Register(&plugin.Registration{
		...
		InitFn: func(ic *plugin.InitContext) (interface{}, error) {
			...
			md.(*metadata2.DB).RegisterCollectibleResource(metadata2.ResourceStream, sm)
			return sm, nil
		},
	})
}
...
func (sm *streamManager) StartCollection(ctx context.Context) (metadata2.CollectionContext, error) {
