...
import (
	...
	cio "demo/over/cri/io"
	opts2 "demo/over/cri/opts"
	container2 "demo/over/cri/store/container"
	util2 "demo/over/cri/util"
	"demo/over/log"
...
func (c *CriService) buildLinuxSpec(id string, sandboxID string, sandboxPid uint32, netNSPath string, containerName string, imageName string, config *runtime.ContainerConfig, sandboxConfig *runtime.PodSandboxConfig, imageConfig *imagespec.ImageConfig, extraMounts []*runtime.Mount, ociRuntime criconfig.Runtime) (_ []oci.SpecOpts, retErr error) {
	specOpts := []oci.SpecOpts{
		oci.WithoutRunMount,
	}
...
func (c *CriService) linuxContainerMounts(sandboxID string, config *runtime.ContainerConfig) []*runtime.Mount {
	var mounts []*runtime.Mount
	securityContext := config.GetLinux().GetSecurityContext()
	if !isInCRIMounts(etcHostname, config.GetMounts()) { // /etc/hostname
...
func (c *CriService) CreateContainer(ctx context.Context, r *runtime.CreateContainerRequest) (_ *runtime.CreateContainerResponse, retErr error) {
	...
	// Create container root directory.  /var/lib/containerd/io.containerd.grpc.v1.cri/containers/60ee8cbb0bfcc5c475ae6e61a3113b4a99829a5092359d723ec5ecae99d32668
	...
	volatileContainerRootDir := c.getVolatileContainerRootDir(id) // /run/containerd/io.containerd.grpc.v1.cri/containers/60ee8cbb0bfcc5c475ae6e61a3113b4a99829a5092359d723ec5ecae99d32668
