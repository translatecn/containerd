...
func (c *criService) setupSandboxFiles(id string, config *runtime.PodSandboxConfig) error {
	sandboxEtcHostname := c.getSandboxHostname(id) // /run/containerd/io.containerd.grpc.v1.cri/sandboxes/2b7c350b765acfa9807033219db54a2915b51164976a55a8cefadfc9b5abc018
...
func (c *criService) sandboxContainerSpecOpts(config *runtime.PodSandboxConfig, imageConfig *imagespec.ImageConfig) ([]oci.SpecOpts, error) {
	...
	if userstr == "" {
		...
		// Image
		userstr = imageConfig.User // 65535:65535
	}
	if userstr != "" {
