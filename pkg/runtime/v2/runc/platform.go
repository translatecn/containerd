...
func (p *linuxPlatform) CopyConsole(ctx context.Context, console console.Console, id, stdin, stdout, stderr string, wg *sync.WaitGroup) (cons console.Console, retErr error) {
	...
	uri, err := url.Parse(stdout) // /run/containerd/io.containerd.grpc.v1.cri/containers/6878c2c912edba819396423bcf72ddde65fbc1d52748c53b0eba2c4eb21517cc/io/3084185352/5d8a5e97c2e6b9358d6c0465c24bb061fd585b20f55f63e8550bd1be587f56ab-stdout
	if err != nil {
